...
export function Gith1Footer({ siteName, contactInfo }: Gith1FooterProps) {
  const footerLinks = {
    product: [
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-2 text-sm text-muted-foreground">
              <a href={`tel:${contactInfo.phone}`} className="flex items-center gap-2 hover:text-foreground transition-colors">
