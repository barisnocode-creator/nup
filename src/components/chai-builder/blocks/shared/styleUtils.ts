...
export function commonStyleSchemaProps(defaults?: Partial<{
  ...
  return {
    titleSize: builderProp({
      ...
      enum: ["lg", "xl", "2xl", "3xl"],
      enumNames: ["Büyük", "Çok Büyük", "Dev", "En Büyük"],
    }),
    titleWeight: builderProp({
      ...
      enumNames: ["Normal", "Orta", "Yarı Kalın", "Kalın", "Ekstra Kalın"],
    }),
    titleColor: builderProp({
      ...
      enumNames: ["Varsayılan", "Ana Renk", "İkincil", "Beyaz", "Soluk"],
    }),
    ...
    descSize: builderProp({
      ...
      enum: ["sm", "base", "lg", "xl"],
      enumNames: ["Küçük", "Normal", "Büyük", "Çok Büyük"],
    }),
    descColor: builderProp({
      ...
      enumNames: ["Varsayılan", "Ana Renk", "Koyu", "Soluk", "Beyaz"],
    }),
    ...
    bgColor: builderProp({
      ...
      enumNames: ["Şeffaf", "Varsayılan", "Soluk", "Kart", "Ana Renk", "İkincil"],
    }),
    sectionPadding: builderProp({
      ...
      enum: ["sm", "md", "lg", "xl"],
      enumNames: ["Dar", "Normal", "Geniş", "Çok Geniş"],
    }),
  };
}
