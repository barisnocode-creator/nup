            ...
            <AnimatePresence>
              {showCustomize && (
                <motion.div
                  ...
                  className="absolute top-full left-0 mt-2 w-[280px] max-h-[calc(100vh-80px)] bg-background border border-border/50 rounded-xl shadow-2xl z-[60] overflow-hidden"
                >
