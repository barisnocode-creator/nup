  ...
  const handleSubmit = async (data: AuthFormData) => {
    ...
    try {
      ...
      if (error) {
        toast({
          variant: 'destructive',
          title: 'Giriş bağlantısı gönderilemedi',
        ...
        <div className="gradient-hero p-6 text-center">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold text-primary-foreground">
              {emailSent ? 'E-postanızı Kontrol Edin' : 'Hoş Geldiniz'}
            </DialogTitle>
            <p className="text-primary-foreground/80 text-sm mt-1">
              {emailSent
                ? 'Giriş bağlantınız gönderildi'
            ...
            <div className="text-center space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  <span className="font-medium text-foreground">{sentEmail}</span> adresine
                  bir giriş bağlantısı gönderdik. E-postanızdaki bağlantıya tıklayarak giriş yapın.
                </p>
              </div>
