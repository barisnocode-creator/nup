        ...
        <div className="gradient-hero p-6 text-center">
          <DialogHeader>
            ...
            <p className="text-primary-foreground/80 text-sm mt-1">
              {emailSent
                ? 'Giriş linkiniz e-posta adresinize gönderildi'
                : 'E-posta ile şifresiz giriş yapın'}
            </p>
          </DialogHeader>
        </div>
          ...
          {emailSent ? (
            <div className="text-center space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                <strong>{form.getValues('email')}</strong> adresine giriş linki gönderdik.
                E-postanızı kontrol edip linke tıklayarak giriş yapabilirsiniz.
              </p>
              <Button
                variant="outline"
                className="w-full"
