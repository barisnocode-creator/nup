      ...
      <div className="min-h-screen">
        ...
        {sections.length === 0 && isEditing && (
          <div className="flex items-center justify-center min-h-[400px]">
            <button
              onClick={() => onAddAt(0)}
              className="flex flex-col items-center gap-3 p-8 rounded-2xl border-2 border-dashed border-gray-300 hover:border-blue-400 hover:bg-blue-50/30 transition-all"
            >
    ...
    <button
      ...
      className={cn(
        ...
        destructive
          ...
          : 'text-gray-500 hover:bg-gray-100 dark:hover:bg-zinc-700 hover:text-gray-900 dark:hover:text-white'
      )}
    >
