  ...
  return (
    ...
    >
      ...
      <div className={`relative container mx-auto px-6 ${s.sectionPadding} text-${s.textAlign}`}>
        ...
        >
          {props.subtitle && (
            <span className={`inline-block px-4 py-2 bg-primary/10 text-primary rounded-full text-sm font-medium mb-6 backdrop-blur-sm ${s.subtitleTransform}`}>
              {props.subtitle}
            </span>
          )}
        </motion.div>
        ...
        <motion.h1
          ...
          className={`${s.titleSize(heroCenteredTitleSizeMap)} ${s.titleWeight} ${props.backgroundImage ? 'text-white' : s.titleColor} leading-tight max-w-4xl mx-auto mb-6`}
        >
          {props.title}
        </motion.h1>
        ...
        <motion.p
          ...
          className={`${s.descSize} ${props.backgroundImage ? 'text-white/80' : s.descColor} max-w-2xl mx-auto mb-10`}
        >
          {props.description}
        </motion.p>
        ...
        >
          {props.primaryButtonText && (
            <a
              ...
              className="inline-flex items-center px-8 py-4 bg-primary text-primary-foreground rounded-lg font-medium hover:bg-primary/90 transition-all duration-300 text-lg shadow-lg hover:shadow-xl hover:-translate-y-0.5"
            >
              {props.primaryButtonText}
          ...
          {props.secondaryButtonText && (
            <a
              ...
              className="inline-flex items-center px-8 py-4 border border-border text-foreground rounded-lg font-medium hover:bg-muted transition-all duration-300 text-lg"
            >
              {props.secondaryButtonText}
            </a>
          )}
